...
export class StepsTrackerDashboard extends Component {
    static template = "step_hr.StepsTrackerDashboard";
    ...
    openWebTracker() {
        return this.action.doAction("step_hr.action_step_tracker_open_web");
    }
...
registry.category("actions").add("step_hr.tracker_dashboard", StepsTrackerDashboard);
