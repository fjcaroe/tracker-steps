"""Redirección idempotente del menú Previred del motor Blueminds."""
...
MENU_XMLID = "l10n_cl_hr.wizard_export_csv_menu"
...
PROFILE_XMLIDS = (
    ...
    "step_hr_previred_blueminds.profile_blueminds_v98",
)
...
def redirect_previred_menu(env):
    ...
    if not menu or not action:
        _logger.info(
            "Previred Blueminds: no se pudo redirigir %s (menú=%s, acción=%s).",
    ...
    _logger.info("Previred Blueminds: menú %s redirigido al asistente Steps.",
                 MENU_XMLID)
